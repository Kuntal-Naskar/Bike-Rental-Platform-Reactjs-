...
const FMainbar = () =>{
    ...
    return(
        ...
        <div className="hback" ><br/>gbfgnfhg
            ...
            <div className="Fmenu"><nav >
                        <img src='logo.png' style={{height:"80px", width:"90px", marginTop:"-17px",marginLeft:"15px"}}></img>
                        <div style={{marginTop:"-50px"}}>

                        <button className="botam" onClick={location}><MdLocationPin  style={{marginLeft:"-20px",marginTop:"-3px"}}/>Kolkata</button>
                        ...
                        <ul style={{marginTop:"-45px", marginLeft:"30px"}}>
                            <li><NavLink to={'/Home'} className={'nav'}>Home</NavLink></li>
                                ...
                                <li><NavLink to={'/Offer'} className={'nav'}>offers</NavLink></li></ul>
                                
                                <div style={{marginLeft:"60px",zIndex:"3"}}><DarkMode /> </div> 
